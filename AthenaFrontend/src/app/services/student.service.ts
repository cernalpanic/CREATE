...
export class StudentService {
  ...
  public AddStudent(student: any): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .post(this.apiUrl + '/Students', JSON.stringify(student), {
  ...
  public GetStudentMentors(StudentID: string): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .get(this.apiUrl + '/Students/' + StudentID + '/Mentors')
        .subscribe(
          (data: any) => {
            resolve(data);
          },
  ...
  public GetModuleProgress(StudentID: string, Details: boolean): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .get(this.apiUrl + '/Students/' + StudentID + '/ModuleProgress', {
          params: new HttpParams().append('Details', Details),
        })
        .subscribe(
          (data: any) => {
            resolve(data);
  ...
  public GetOverallProgress(StudentID: string): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .get(this.apiUrl + '/Students/' + StudentID + '/Progress')
        .subscribe(
          (data: any) => {
            resolve(data);
          },
  ...
  public SaveStudentMentors(StudentID: string, Mentors: Role[]): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .post(
          this.apiUrl + '/Students/' + StudentID + '/Mentors',
  ...
  public GetStudent(StudentID: string): Promise<any> {
    return new Promise((resolve) => {
      this.http.get(this.apiUrl + '/Students/' + StudentID).subscribe(
        (data: any) => {
          resolve(data);
        },
        (error) => {
  ...
  public UpdateStudent(student: any): Promise<any> {
    return new Promise((resolve) => {
      this.http
        .put(this.apiUrl + '/Students/Update', JSON.stringify(student), {
          headers: this.postHeaders,
        })
        .subscribe(
          (data: any) => {
